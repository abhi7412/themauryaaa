 ...
 */ var wt = {
  ...
  yu = { suppressEvents: !0, isStart: !0, kill: !1 },
  ...
  Ns = function (e) {
    ...
    for (i = e.length; i--;)
      (e[i] && (e[i]._gsap || (e[i]._gsap = new va(e[i], t)))) ||
        e.splice(i, 1);
    return e;
  },
  Br = function (e) {
  ...
  Qo = function (e, r, t) {
    return (t = e[r]) && pe(t)
      ? e[r]()
      : (Rs(t) && e.getAttribute && e.getAttribute(r)) || t;
  },
  ut = function (e, r) {
  ...
  ta = function (e, r) {
    ...
    if (
      ((r._time ||
        ...
        ((t = An(e.rawTime(), r)),
        (!r._dur || nn(0, r.totalDuration(), t) - r._tTime > re) &&
          r.render(t, !0)),
  ...
  $t = function (e, r, t, i) {
    return (
      ...
      ea(e, r, "_first", "_last", e._sort ? "_start" : 0),
      cs(r) || (e._recent = r),
      i || ta(e, r),
  ...
  ra = function (e, r) {
    return (
      (St.ScrollTrigger || Fs("scrollTrigger", r)) &&
      St.ScrollTrigger.create(r, e)
    );
  },
  ia = function (e, r, t, i, n) {
    if ((Xs(e, r, n), !e._initted)) return 1;
    if (
      !t &&
      e._pt &&
      !Ie &&
  ...
  ku = function (e, r, t, i) {
    ...
    if (
      ...
      s !== n || Ie || i || e._zTime === re || (!r && e._zTime))
    ) {
      if (!e._initted && ia(e, r, i, t, u)) return;
      for (
        _ = e._zTime,
          e._zTime = r || (t ? re : 0),
          t || (t = r && !_),
      ...
      (r < 0 && fs(e, r, t, !0),
        ...
        u && e._repeat && !t && e.parent && Tt(e, "onRepeat"),
        (r >= e._tDur || r < 0) &&
          e.ratio === s &&
          (s && wr(e, 1),
          !t &&
  ...
  Ou = { _start: 0, endTime: Ki, totalDuration: Ki },
  Pt = function a(e, r, t) {
    var i = e.labels,
      n = e._recent || Ou,
  ...
  Et = function (e, r, t) {
    return ae && !r && ae.selector
      ? ae.selector(e)
      : Re(e) && !t && (us || !yi())
        ? hs.call((r || zs).querySelectorAll(e), 0)
        : He(e)
          ? Du(e, t)
          : na(e)
            ? hs.call(e, 0)
      ...
      function (r) {
        ...
        return Et(
          ...
          t.querySelectorAll
            ? t
            : t === e
              ? qi("Invalid scope") || zs.createElement("div")
              : e,
        );
      }
    );
      ...
      function (d, c, p) {
        ...
        if (!m) {
          if (((C = r.grid === "auto" ? 0 : (r.grid || [1, Dt])[1]), !C)) {
            for (
              x = -Dt;
              x < (x = p[C++].getBoundingClientRect().left) && C < h;
            );
            C < h && C--;
          }
          for (
            m = s[h] = [],
              b = u ? Math.min(C, h) * f - 0.5 : i % C,
              T = C === Dt ? 0 : u ? (h * _) / C - 0.5 : (i / C) | 0,
              x = 0,
              O = Dt,
              k = 0;
            k < h;
            ...
            ((S = (k % C) - b),
              (v = T - ((k / C) | 0)),
              (m[k] = w = l ? Math.abs(l === "y" ? v : S) : Vo(S * S + v * v)),
              w > x && (x = w),
              w < O && (O = w));
          (i === "random" && sa(m),
            (m.max = x - O),
  ...
  Qi = function (e) {
    return e.replace(du, function (r) {
      ...
      return ua(t ? i : +i[0], t ? 0 : +i[1], +i[2] || 1e-5);
    });
  },
  fa = function (e, r, t, i, n) {
    var s = r - e,
      o = i - t;
  ...
  Lu = function a(e, r, t, i) {
    ...
    if (!n) {
      ...
      if (!f) {
        for (u in r) Bs.call(o, e, u, "get", r[u]);
        n = function (p) {
          return Ws(p, o) || (s ? e.p : e);
        };
      }
    }
    return Pr(t, n);
  ...
  ha = function (e) {
    if (e)
      if (((e = (!e.name && e.default) || e), As() || e.headless)) {
        var r = e.name,
          t = pe(e),
          i =
            r && !t && e.init
        ...
        if ((yi(), e !== i)) {
          if (mt[r]) return;
          (Ct(i, Ct(Rn(e, n), s)),
            pi(i.prototype, pi(n, Rn(e, s))),
            (mt[(i.prop = r)] = i),
            e.targetTest && (bn.push(i), (Ls[r] = 1)),
            (r =
  ...
  _a = function (e, r, t) {
    var i = e ? (or(e) ? [e >> 16, (e >> 8) & te, e & te] : 0) : Mi.black,
      n,
      s,
      o,
      u,
    ...
    if (!i) {
      if ((e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Mi[e]))
        ...
        if (
          ...
          return (
            ...
            [i >> 16, (i >> 8) & te, i & te, parseInt(e.substr(7), 16) / 255]
          );
      ...
      } else i = e.match(no) || Mi.transparent;
      i = i.map(Number);
    }
    return (
      r &&
  ...
  fo = function (e, r, t) {
    ...
    if (
      ...
      t && ((f = da(e)), (u = t.c), u.join(i) !== f.c.join(i)))
    )
    ...
    if (!l)
      for (l = e.split(Tr), _ = l.length - 1; o < _; o++) i += l[o] + n[o];
    return i + l[_];
  },
  Tr = (function () {
    var a =
    ...
    var a = Date.now,
      ...
      p = function h(m) {
        ...
        if (
          ...
          for (c = 0; c < o.length; c++) o[c](w, d, k, m);
      };
    return (
      (_ = {
        time: 0,
        ...
        wake: function () {
          Go &&
            (!us &&
              ...
              Ho(Dn || Ut.GreenSockGlobals || (!Ut.gsap && Ut) || {}),
              ca.forEach(ha)),
  ...
  Bu = function (e) {
    for (
      ...
      ((u = t[n]),
        ...
        (l = u.substr(0, o)),
        (r[i] = isNaN(l) ? l.replace(Yu, "").trim() : +l),
        (i = u.substr(o + 1).trim()));
    return r;
  },
  Xu = function (e) {
  ...
  Vu = function (e) {
    ...
    return t && r.length > 1 && t.config
      ? t.config.apply(
          null,
          ~e.indexOf("{") ? [Bu(r[1])] : Xu(e).split(",").map(Jo),
        )
      : q._CE && Nu.test(e)
        ? q._CE("", e)
        : t;
    ...
    return (
      ...
      (e.totalTime = function (t, i) {
        ...
        if (n && n.smoothChildTiming && this._ts) {
          for (Un(this, t), !n._dp || n.parent || ta(n, this); n && n.parent;)
            (n.parent._time !==
              n._start +
                (n._ts >= 0
                  ? n._tTime / n._ts
        ...
        return (
          (this._tTime !== t ||
            ...
            (this._ts || (this._pTime = t), Zo(this, t, i)),
          this
        );
      }),
      (e.time = function (t, i) {
        return arguments.length
          ? this.totalTime(
              Math.min(this.totalDuration(), t + ao(this)) %
      ...
      (e.timeScale = function (t, i) {
        ...
        var n =
          this.parent && this._ts ? An(this.parent._time, this) : this._tTime;
        return (
          (this._rts = +t || 0),
          (this._ts = this._ps || t === -re ? 0 : this._rts),
          this.totalTime(
            nn(-Math.abs(this._delay), this.totalDuration(), n),
            i !== !1,
          ),
          Vn(this),
          wu(this)
      ...
      (e.repeat = function (t) {
        return arguments.length
          ? ((this._repeat = t === 1 / 0 ? -2 : t), uo(this))
          : this._repeat === -2
            ? 1 / 0
            : this._repeat;
      }),
...
var it = (function (a) {
  ...
  function e(t, i) {
    ...
    return (
      ...
      t.paused && n.paused(!0),
      t.scrollTrigger && ra(tr(n), t.scrollTrigger),
      n
    );
  }
  var r = e.prototype;
  return (
    ...
    (r.staggerFrom = function (i, n, s, o, u, l, f) {
      return (
        (s.runBackwards = 1),
        (Fi(s).immediateRender = at(s.immediateRender)),
    ...
    (r.staggerFromTo = function (i, n, s, o, u, l, f, _) {
      return (
        (o.startAt = s),
        (Fi(o).immediateRender = at(o.immediateRender)),
      ...
      if (
        ...
        if (
          (this._hasPause &&
            !this._forcing &&
            this._lock < 2 &&
            ((T = Pu(this, le(o), le(d))), T && (f -= d - (d = T._start))),
          (this._tTime = f),
          (this._time = d),
          (this._act = !S),
          this._initted ||
            ...
            (this._zTime = i),
            (o = 0)),
          !o && f && l && !n && !w && (Tt(this, "onStart"), this._tTime !== f))
        )
          return this;
        if (d >= o && i >= 0)
          for (c = this._first; c;) {
            if (
              ((p = c._next), (c._act || d >= c._start) && c._ts && T !== c)
            ) {
        ...
        if (
          ...
          !n &&
          (this.pause(),
          (T.render(d >= o ? 0 : -re)._zTime = d >= o ? 1 : -1),
          this._ts)
        )
          ...
          Ct(
            {
              ...
              onStart: function () {
                if ((s.pause(), !c)) {
                  ...
                  (p._dur !== m && mi(p, m, 0, 1).render(p._time, !0, !0),
                    (c = 1));
                }
                f && f.apply(p, _ || []);
              },
    ...
    (r.nextLabel = function (i) {
      return (i === void 0 && (i = this._time), lo(this, Pt(this, i)));
    }),
    (r.previousLabel = function (i) {
      return (i === void 0 && (i = this._time), lo(this, Pt(this, i), 1));
    }),
    ...
    (e.updateRoot = function (i) {
      if ((fe._ts && (Zo(fe, An(i, fe)), (Ko = vt.frame)), vt.frame >= so)) {
        so += wt.autoSleep || 120;
        var n = fe._first;
...
Ct(it.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
var Uu = function (e, r, t, i, n, s, o) {
    var u = new lt(this._pt, e, r, 0, 1, Ca, null, n),
      l = 0,
      f = 0,
      _,
      d,
    ...
    if (
      ...
      return !isNaN(d * i) && i !== ""
        ? ((p = new lt(
          ...
          (this._pt = p))
        : (!_ && !(r in e) && Fs(r, i),
          Uu.call(this, e, r, d, i, c, u || wt.stringFilter, l));
  },
  Wu = function (e, r, t, i, n) {
    if (
      (pe(e) && (e = Ii(e, n, r, t, i)),
      !Kt(e) || (e.style && e.nodeType) || He(e) || Uo(e))
    )
      return Re(e) ? Ii(e, n, r, t, i) : e;
    var s = {},
      o;
    for (o in e) s[o] = Ii(e[o], n, r, t, i);
    return s;
  },
  ...
  Xs = function a(e, r, t) {
    ...
    if (
      (v && (!d || !n) && (n = "none"),
      (e._ease = Vr(n, di.ease)),
      (e._yEase = _ ? ga(Vr(_ === !0 ? n : _, di.ease)) : 0),
      _ &&
        e._yoyo &&
        !e._repeat &&
      ...
      if (
        ((M = m[0] ? Br(m[0]).harness : 0),
        ($ = M && i[M.prop]),
        (w = Rn(i, Ls)),
        h &&
          (h._zTime < 0 && h.progress(1),
          r < 0 && f && o && !c ? h.render(-1, !0) : h.revert(f && p ? Tn : yu),
          (h._lazy = 0)),
        s)
      ) {
        if (
      ...
      for (
        e._pt = e._ptCache = 0, u = (p && at(u)) || (u && !p), k = 0;
        k < m.length;
        k++
      ) {
        if (
          ((C = m[k]),
          (F = C._gsap || Ns(m)[k]._gsap),
          (e._ptLookup[k] = V = {}),
          ls[F.id] && xr.length && En(),
          (K = T === m ? k : T.indexOf(C)),
          M &&
            (W = new M()).init(C, $ || w, e, K, T) !== !1 &&
            ((e._pt = O =
              new lt(e._pt, C, W.name, 0, 1, W.render, W, 0, W.priority)),
            W._props.forEach(function (Z) {
              V[Z] = O;
            }),
            W.priority && (P = 1)),
          !M || $)
          ...
          for (x in w)
            mt[x] && (W = xa(x, w, e, K, C, T))
              ? W.priority && (P = 1)
              : (V[x] = O =
                  Bs.call(e, C, x, "get", w[x], K, T, 0, i.stringFilter));
        (e._op && e._op[k] && e.kill(C, e._op[k]),
          S &&
            e._pt &&
            ((pr = e),
            fe.killTweensOf(C, V, e.globalTime(r)),
            (z = !e.parent),
            (pr = 0)),
          e._pt && u && (ls[F.id] = 1));
      }
      (P && ka(e), e._onInit && e._onInit(e));
    }
    ((e._onUpdate = l),
      (e._initted = (!e._op || e._pt) && !z),
      d && r <= 0 && v.render(Dt, !0, !0));
  },
      ...
      for (
        ...
        if (!f)
          return (
            ...
            Xs(e, o),
            (ps = 0),
            u ? qi(r + " not eligible for reset") : 1
          );
        l.push(f);
      }
    for (c = l.length; c--;)
  ...
  Ta = Is + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",
  ba = {};
...
var Se = (function (a) {
  ...
  function e(t, i, n, s) {
    ...
    var u = o.vars,
      ...
      b = u.yoyoEase,
      T = i.parent || fe,
      S = (He(t) || Uo(t) ? or(t[0]) : "length" in i) ? [t] : Et(t),
      v,
      w,
      k,
      x,
    ...
    if (
      ...
      if (
        ...
        if (((x = S.length), (P = d && oa(d)), Kt(d)))
          for (O in d) ~Ta.indexOf(O) && (F || (F = {}), (F[O] = d[O]));
        for (w = 0; w < x; w++)
          ((k = Rn(i, ba)),
            (k.stagger = 0),
            b && (k.yoyoEase = b),
            F && pi(k, F),
            (C = S[w]),
            (k.duration = +Ii(l, tr(o), w, C, S)),
            (k.delay = (+Ii(f, tr(o), w, C, S) || 0) - o._delay),
            !d &&
              x === 1 &&
              k.delay &&
              ((o._delay = f = k.delay), (o._start += f), (k.delay = 0)),
            v.to(C, k, P ? P(w, C, S) : 0),
            (v._ease = q.none));
        v.duration() ? (l = f = 0) : (o.timeline = 0);
      } else if (p) {
        (Fi(Ct(v.vars.defaults, { ease: "none" })),
        ...
        if (He(p))
          ...
          k = {};
          for (O in p)
            O === "ease" || O === "easeEach" || Hu(O, p[O], k, p.easeEach);
          for (O in k)
            for (
              W = k[O].sort(function ($, z) {
                return $.t - z.t;
              }),
                M = 0,
                w = 0;
    ...
    return (
      c === !0 && !Es && ((pr = tr(o)), fe.killTweensOf(S), (pr = 0)),
      $t(T, tr(o), n),
      ...
      (_ ||
        (!l &&
          ...
          Su(tr(o)) &&
          T.data !== "nested")) &&
        ((o._tTime = -re), o.render(Math.max(0, -f) || 0)),
      m && ra(tr(o), m),
      o
    );
  }
  ...
  return (
    (r.render = function (i, n, s) {
      ...
      if (!l) ku(this, i, n, s);
        ...
        if (!this._initted) {
          if (ia(this, f ? i : d, s, n, _)) return ((this._tTime = 0), this);
        ...
        if (
          ...
          (this.ratio = T = (v || this._ease)(d / l)),
          this._from && (this.ratio = T = 1 - T),
          !o && _ && !n && !m && (Tt(this, "onStart"), this._tTime !== _))
        )
          return this;
        ...
        ((S && S.render(i < 0 ? i : S._dur * S._ease(d / this._dur), n, s)) ||
          ...
          this._onUpdate &&
            !n &&
            (f && fs(this, i, n, s), Tt(this, "onUpdate")),
          this._repeat &&
            p !== m &&
            this.vars.onRepeat &&
            !n &&
          ...
          (_ === this._tDur || !_) &&
            ...
            !n &&
              !(f && !o) &&
              (_ || o || b) &&
              (Tt(this, _ === u ? "onComplete" : "onReverseComplete", !0),
    ...
    (r.resetTo = function (i, n, s, o, u) {
      ...
      var l = Math.min(this._dur, (this._dp._time - this._start) * this._ts),
        f;
      return (
        this._initted || Xs(this, l),
        (f = this._ease(l / this._dur)),
        $u(this, i, n, s, o, f, l, u)
      ...
      if (this.timeline) {
        ...
        return (
          ...
          this.parent &&
            ...
            mi(this, (this._dur * this.timeline._tDur) / s, 0, 1),
          this
        );
      }
      var o = this._targets,
...
var Vs = function (e, r, t) {
  ...
  Us = function (e, r) {
    return pe(e[r]) ? wa : Rs(e[r]) && e.setAttribute ? Ku : Vs;
  },
  Sa = function (e, r) {
  ...
  zn = {
    ...
    registerEffect: function (e) {
      ...
      ((i || "").split(",").forEach(function (o) {
        return (
          o && !mt[o] && !St[o] && qi(r + " effect requires " + o + " plugin.")
        );
      }),
        (Hn[r] = function (o, u, l) {
 ...
 */ var ho,
  ...
  po = 1e8,
  Hs = /([A-Z])/g,
  ol = /(left|right|width|margin|padding|x)/i,
  al = /[\s,\(]\S/,
  Gt = {
  ...
  Ea = function (e, r) {
    var t = { target: e, props: [], revert: vl, save: yl };
    return (
      ...
      (r in ar && r !== ft && (r = ce),
        t.removeProperty
          ? ((i = r.substr(0, 2)),
            ...
            t.removeProperty(
              i === "--" ? r : r.replace(Hs, "-$1").toLowerCase(),
            ))
          : t.removeAttribute(r));
    }
  },
  mr = function (e, r, t, i, n, s) {
    var o = new lt(e._pt, r, t, 0, 1, s ? Ma : Oa);
  ...
  Cr = function a(e, r, t, i) {
    ...
    if (
      ...
      (m = h._gsap),
      m && c && m.width && u && m.time === vt.time && !m.uncache)
    )
    ...
    if (c && (r === "height" || r === "width")) {
      ...
      ((c || s === "%") &&
        ...
        (o.position = "absolute"));
    return (
      u && c && ((m = Br(h)), (m.time = vt.time), (m.width = h[f])),
      ve(d ? (p * n) / _ : p && n ? (_ / p) * n : 0)
    );
  },
  rr = function (e, r, t, i) {
    var n;
  ...
  Tl = function (e, r, t, i) {
    ...
    var o = new lt(this._pt, e.style, r, 0, 1, Ca),
      u = 0,
      l = 0,
      f,
      _,
      ...
      for (; (_ = si.exec(i));)
        ((m = _[0]),
          ...
          m !== (h = d[l++] || "") &&
            ((c = parseFloat(h) || 0),
            (v = h.substr((c + "").length)),
            m.charAt(1) === "=" && (m = ui(c, m) + v),
            (b = parseFloat(m)),
            (S = m.substr((b + "").length)),
            (u = si.lastIndex - S.length),
            S ||
              ((S = S || wt.units[r] || v),
    ...
    } else o.r = r === "display" && i === "none" ? Ma : Oa;
  ...
  Fn = {
    clearProps: function (e, r, t, i, n) {
      if (n.data !== "isFromStart") {
        var s = (e._pt = new lt(e._pt, r, t, 0, 0, wl));
  ...
  xs = function (e, r, t, i, n, s) {
    ...
    (t
      ? u !== ji &&
        (x = c * m - p * h) &&
        ((O = v * (m / x) + w * (-h / x) + (h * T - m * b) / x),
        (C = v * (-p / x) + w * (c / x) - (c * T - p * b) / x),
        (v = O),
        (w = C))
      : ((k = Aa(e)),
        (v = k.x + (~S[0].indexOf("%") ? (v / 100) * k.width : v)),
        (w = k.y + (~(S[1] || S[0]).indexOf("%") ? (w / 100) * k.height : w))),
      i || (i !== !1 && o.smooth)
        ? ((b = v - l),
          (T = w - f),
          (o.xOffset = _ + (b * c + T * h) - b),
          (o.yOffset = d + (b * p + T * m) - T))
  ...
  en = function (e, r) {
    ...
    return (
      ...
      t.svg &&
        ...
        xs(e, z || l, !!z || t.originIsAbsolute, t.smooth !== !1, x)),
      (w = t.xOrigin || 0),
      (k = t.yOrigin || 0),
      x !== ji &&
        ((F = x[0]),
        ...
        x.length === 6
          ? ((c = Math.sqrt(F * F + M * M)),
            ...
            (h = F || M ? ei(M, F) * Fr : 0),
            (T = W || V ? ei(W, V) * Fr + h : 0),
            T && (p *= Math.abs(Math.cos(T * fi))),
            t.svg && ((f -= w - (w * F + k * W)), (_ -= k - (w * M + k * V))))
          : ((Ae = x[6]),
            (At = x[7]),
            (g = x[8]),
            (se = x[9]),
            ...
            (p = ve(Math.sqrt($ * $ + Ae * Ae))),
            (O = ei(K, $)),
            (T = Math.abs(O) > 2e-4 ? O * Fr : 0),
            (v = he ? 1 / (he < 0 ? -he : he) : 0)),
        t.svg &&
          ((z = e.getAttribute("transform")),
          (t.forceCSS = e.setAttribute("transform", "") || !La(bt(e, ce))),
          z && e.setAttribute("transform", z))),
      Math.abs(T) > 90 &&
        Math.abs(T) < 270 &&
        (n
          ? ((c *= -1), (T += h <= 0 ? 180 : -180), (h += h <= 0 ? 180 : -180))
          : ((p *= -1), (T += T <= 0 ? 180 : -180))),
      (r = r || t.uncache),
      (t.x =
        f -
      ...
      (t.renderTransform = t.svg ? Cl : Ra ? Ia : Sl),
      (t.uncache = 0),
      t
    );
  },
  ...
  Ia = function (e, r) {
    ...
    if (S && (_ !== Ar || f !== Ar)) {
      ...
      ((k = parseFloat(_) * fi),
        (C = Math.cos(k)),
        (s = jn(T, s, x * C * -S)),
        (o = jn(T, o, -Math.sin(k) * -S)),
        (u = jn(T, u, O * C * -S + S)));
    }
    (m !== Ci && (v += "perspective(" + m + zr),
      (i || n) && (v += "translate(" + i + "%, " + n + "%) "),
      (w || s !== Ci || o !== Ci || u !== Ci) &&
        (v +=
          u !== Ci || w
      ...
      f !== Ar && (v += "rotateY(" + f + zr),
      _ !== Ar && (v += "rotateX(" + _ + zr),
      (d !== Ar || c !== Ar) && (v += "skew(" + d + ", " + c + zr),
      (p !== 1 || h !== 1) && (v += "scale(" + p + ", " + h + zr),
      (T.style[ce] = v || "translate(0, 0)"));
  },
  Cl = function (e, r) {
    var t = r || this,
      i = t.xPercent,
    ...
    ((u = parseFloat(u)),
      ...
      u || l
        ? ((u *= fi),
          ...
          (O = ve(O)))
        : ((w = _), (O = d), (k = x = 0)),
      ((S && !~(s + "").indexOf("px")) || (v && !~(o + "").indexOf("px"))) &&
        ((S = Cr(c, "x", s, "px")), (v = Cr(c, "y", o, "px"))),
      (p || h || m || b) &&
        ((S = ve(S + p - (p * w + h * x) + m)),
        (v = ve(v + h - (p * k + h * O) + b))),
      (i || n) &&
        ((C = c.getBBox()),
        (S = ve(S + (i / 100) * C.width)),
        (v = ve(v + (n / 100) * C.height))),
      (C =
        "matrix(" + w + "," + k + "," + x + "," + O + "," + S + "," + v + ")"),
  ...
  kl = function (e, r, t, i, n) {
    var s = 360,
      o = Re(n),
      u = parseFloat(n) * (o && ~n.indexOf("rad") ? Fr : 1),
      l = u - i,
      f = i + l + "deg",
      _,
      d;
    return (
      o &&
        ...
        _ === "cw" && l < 0
          ? (l = ((l + s * po) % s) - ~~(l / s) * s)
          : _ === "ccw" && l > 0 && (l = ((l - s * po) % s) - ~~(l / s) * s)),
      (e._pt = d = new lt(e._pt, r, t, i, l, ul)),
      (d.e = f),
      (d.u = "deg"),
      e._props.push(t),
      d
    ...
    for (u in ar)
      ((l = i[u]),
        ...
        l !== f &&
          ...
          (d = parseFloat(f)),
          (e._pt = new lt(e._pt, o, u, _, d - _, ms)),
          (e._pt.u = p || 0),
          e._props.push(u)));
    bo(o, i);
  };
ut("padding,margin,Width,Radius", function (a, e) {
  ...
  Fn[e > 1 ? "border" + a : a] = function (o, u, l, f, _) {
    var d, c;
...
var Na = {
  ...
  init: function (e, r, t, i, n) {
    var s = this._props,
      ...
      C;
    ($s || vs(),
      (this.styles = this.styles || Ea(e)),
      (O = this.styles.props),
      (this.tween = t));
    for (h in r)
      if (h !== "autoRound" && ((f = r[h]), !(mt[h] && xa(h, r, t, i, e, n)))) {
        if (
          ((c = typeof f),
          (p = Fn[h]),
          c === "function" && ((f = f.call(t, i, e, n)), (c = typeof f)),
          c === "string" && ~f.indexOf("random(") && (f = Qi(f)),
          p)
        )
          p(this, e, h, f, t) && (x = 1);
          ...
          if (
            (u && h in u
              ? ((l = typeof u[h] == "function" ? u[h].call(t, i, e, n) : u[h]),
                Re(l) && ~l.indexOf("random(") && (l = Qi(l)),
                $e(l + "") ||
                  l === "auto" ||
                  (l += wt.units[h] || $e(rr(e, h)) || ""),
                (l + "").charAt(1) === "=" && (l = rr(e, h)))
              : (l = rr(e, h)),
            (d = parseFloat(l)),
            ...
            if (
              (v ||
                ...
                (k = r.smoothOrigin !== !1 && w.smooth),
                (v = this._pt =
                  new lt(this._pt, o, ce, 0, 1, w.renderTransform, w, 0, -1)),
                (v.dep = 1)),
              h === "scale")
            )
              ((this._pt = new lt(
                ...
                "scaleY",
                w.scaleY,
                (T ? ui(w.scaleY, T + _) : _) - w.scaleY || 0,
                ms,
              )),
                (this._pt.u = 0),
                s.push("scaleY", h),
              ...
              (O.push(ft, 0, o[ft]),
                ...
                w.svg
                  ...
                  : ((b = parseFloat(f.split(" ")[2]) || 0),
                    b !== w.zOrigin && mr(this, w, "zOrigin", w.zOrigin, b),
                    mr(this, o, h, Ln(l), Ln(f))));
              continue;
            } else if (h === "svgOrigin") {
              xs(e, f, 1, k, 0, this);
              continue;
            } else if (h in Fa) {
              kl(this, w, h, d, T ? ui(d, T + f) : f);
              continue;
          ...
          if (S || ((_ || _ === 0) && (d || d === 0) && !al.test(f) && h in o))
            ((m = (l + "").substr((d + "").length)),
              _ || (_ = 0),
              (b = $e(f) || (h in wt.units ? wt.units[h] : m)),
              m !== b && (d = Cr(e, h, l, b)),
              (this._pt = new lt(
                this._pt,
                S ? w : o,
              ...
              (this._pt.u = b || 0),
              S && C !== f
                ? ((this._pt.b = l), (this._pt.e = C), (this._pt.r = fl))
                : m !== b &&
                  b !== "%" &&
                  ((this._pt.b = l), (this._pt.r = ll)));
          else if (h in o) Tl.call(this, e, h, l, T ? T + f : f);
          else if (h in e) this.add(e, h, l || e[h], T ? T + f : f, i, n);
...
ct.core.getStyleSaver = Ea;
(function (a, e, r, t) {
  var i = ut(a + "," + e + "," + r, function (n) {
    ar[n] = 1;
  });
  (ut(e, function (n) {
    ((wt.units[n] = "deg"), (Fa[n] = 1));
  }),
    (Gt[i[13]] = a + "," + e),
    ut(t, function (n) {
      var s = n.split(":");
...
ct.registerPlugin(Na);
var Ol = ct.registerPlugin(Na) || ct;
Ol.core.Tween;
function Ml(a, e) {
 ...
 */ var Le,
  ...
  In = function (e, r) {
    var t = function i(n) {
      if (n || n === 0) {
        Ua && (xt.history.scrollRestoration = "manual");
  ...
  nt = {
    ...
    sc: In(function (a) {
      return arguments.length
        ? xt.scrollTo(a, Pe.sc())
        : xt.pageXOffset || yr[ln] || vr[ln] || ci[ln] || 0;
    }),
  },
  Pe = {
    s: fn,
    ...
    sc: In(function (a) {
      return arguments.length
        ? xt.scrollTo(nt.sc(), a)
        : xt.pageYOffset || yr[fn] || vr[fn] || ci[fn] || 0;
    }),
  },
  ot = function (e, r) {
    return (
  ...
  kr = function (e, r) {
    ...
    var n = X.indexOf(e),
      s = i === Pe.sc ? 1 : 2;
    (!~n && (n = X.push(e) - 1), X[n + s] || je(e, "scroll", bs));
    var o = X[n + s],
      u =
        o ||
        (X[n + s] =
  ...
  Wa = function () {
    ((Ni = Le.core.globals().ScrollTrigger), Ni && Ni.core && El());
  },
  $a = function (e) {
    return (
      (Le = e || Va()),
      !Sn &&
        ...
        (Ba = [xt, yr, vr, ci]),
        Le.utils.clamp,
        (Xa = Le.core.context || function () {}),
        (Lr = "onpointerenter" in ci ? "pointer" : "mouse"),
        (Ya = xe.isTouch =
          xt.matchMedia &&
...
var xe = (function () {
  ...
  return (
    (e.init = function (t) {
      (Sn || $a(Le) || console.warn("Please gsap.registerPlugin(Observer)"),
        Ni || Wa());
      var i = t.tolerance,
        n = t.dragMinimum,
        s = t.type,
      ...
      ((this.target = o = ot(o) || vr),
        ...
        (l = l !== !1),
        u || (u = parseFloat(xt.getComputedStyle(ci).lineHeight) || 22));
      var ur,
        Qe,
        Ze,
        Q,
        ...
        be = function (A, J) {
          return (
            ((y.event = A) && c && Rl(A.target, c)) ||
            (J && Oe && A.pointerType !== "touch") ||
            (z && z(A, J))
          );
        },
        sn = function () {
        ...
        jt = function () {
          ...
          (F && (D || L) && F(y, A, J, zt, kt),
            ...
            L &&
              ...
              x && y.deltaY < 0 && x(y),
              P && P(y),
              W && y.deltaY < 0 != Qt < 0 && W(y),
              (Qt = y.deltaY),
              (kt[0] = kt[1] = kt[2] = 0)),
            (Q || Ze) &&
              ($ && $(y),
              Ze && (m && Ze === 1 && m(y), T && T(y), (Ze = 0)),
              (Q = !1)),
            st && !(st = !1) && Ye && Ye(y),
            ge && (se(y), (ge = !1)),
            (ur = 0));
        ...
        Jr = function (A, J) {
          (Ke &&
            !ht &&
            ((y.axis = ht = Math.abs(A) > Math.abs(J) ? "x" : "y"), (st = !0)),
            ht !== "y" && ((zt[2] += A), y._vx.update(A, !0)),
            ht !== "x" && ((kt[2] += J), y._vy.update(J, !0)),
            l ? ur || (ur = requestAnimationFrame(jt)) : jt());
        },
        hr = function (A) {
          if (!be(A, 1)) {
              ...
              (I ||
                ((L || R) &&
                  (Math.abs(y.startX - J) >= n ||
                    Math.abs(y.startY - D) >= n))) &&
                (Ze || (Ze = I ? 2 : 1), I || (y.isDragging = !0), Jr(L, R)));
          }
        },
        Mr = (y.onPress = function (N) {
          be(N, 1) ||
            ...
            (N = ki(N)),
            (_t = Qt = 0),
            (y.startX = y.x = N.clientX),
            (y.startY = y.y = N.clientY),
            y._vx.reset(),
            y._vy.reset(),
            je(Z ? o : me, Yt[1], hr, lr, !0),
            (y.deltaX = y.deltaY = 0),
            S && S(y));
        }),
        ...
        It = function (A) {
          if (!be(A)) {
            ((A = ki(A, f)), se && (ge = !0));
            var J =
              (A.deltaMode === 1 ? u : A.deltaMode === 2 ? xt.innerHeight : 1) *
              p;
        ...
        bi = function (A) {
          return be(A) || (ki(A, f) && he(y));
        };
      ((Qe = y._dc = Le.delayedCall(d || 0.25, sn).pause()),
        (y.deltaX = y.deltaY = 0),
        (y._vx = ws(0, 50, !0)),
        (y._vy = ws(0, 50, !0)),
        (y.scrollX = _e),
        ...
        (y.enable = function (N) {
          return (
            y.isEnabled ||
              (je(cr ? me : o, "scroll", bs),
              s.indexOf("scroll") >= 0 && je(cr ? me : o, "scroll", Lt, lr, Ne),
              s.indexOf("wheel") >= 0 && je(o, "wheel", It, lr, Ne),
              ((s.indexOf("touch") >= 0 && Ya) || s.indexOf("pointer") >= 0) &&
                (je(o, Yt[0], Mr, lr, Ne),
                je(me, Yt[2], U),
                je(me, Yt[3], U),
                Te && je(o, "click", Ti, !0, !0),
                he && je(o, "click", bi),
                ne && je(me, "gesturestart", Dr),
                g && je(me, "gestureend", Ft),
                V && je(o, Lr + "enter", jr),
                K && je(o, Lr + "leave", er),
                $ && je(o, Lr + "move", Er)),
              (y.isEnabled = !0),
              (y.isDragging = y.isGesturing = y.isPressed = Q = Ze = !1),
              y._vx.reset(),
              y._vy.reset(),
              (fr = _e()),
              (Or = Zt()),
        ...
        (y.disable = function () {
          y.isEnabled &&
            (ai.filter(function (N) {
              return N !== y && Bi(N.target);
            }).length || Je(cr ? me : o, "scroll", bs),
            y.isPressed &&
              (y._vx.reset(), y._vy.reset(), Je(Z ? o : me, Yt[1], hr, !0)),
 ...
 */ var E,
  ...
  Za = function () {
    return E || (Qa() && (E = window.gsap) && E.registerPlugin && E);
  },
  Hr = function (e) {
    return !!~Ks.indexOf(e);
  },
  ...
  ja = function (e) {
    return (
      ...
      (Hr(e)
        ? function () {
            return ((Mn.width = B.innerWidth), (Mn.height = Zs), Mn);
          }
        : function () {
            return ir(e);
          })
  ...
  mn = function (e, r, t, i, n, s, o, u) {
    ...
    return (
      (v += "position:" + ((m || u) && h ? "fixed;" : "absolute;")),
      (m || u || !h) &&
        (v += (i === Pe ? Js : js) + ":" + (s + parseFloat(d)) + "px;"),
      o &&
        (v +=
  ...
  ri = function () {
    (!et || !et.isPressed || et.startX > j.clientWidth) &&
      (X.cache++,
      et ? rn || (rn = requestAnimationFrame(sr)) : sr(),
      Rt || Kr("scrollStart"),
      (Rt = We()));
  },
  ns = function () {
    ((Ka = B.innerWidth), (qa = B.innerHeight));
  },
  zi = function (e) {
    (X.cache++,
      (e === !0 ||
        (!Ue &&
          ...
          (!Cs ||
            Ka !== B.innerWidth ||
            Math.abs(B.innerHeight - qa) > B.innerHeight * 0.25))) &&
        Nn.restart(!0));
  },
  qr = {},
  Yl = [],
  iu = function a() {
    return De(G, "scrollEnd", a) || Yr(!0);
  },
  Kr = function (e) {
    return (
      (qr[e] &&
  ...
  ou = function (e, r) {
    (X.cache++,
      ...
      gt(e) && (B.history.scrollRestoration = Qs = e));
  },
  rt,
  Gr = 0,
  Ao,
  ...
  au = function () {
    (j.appendChild(hi),
      (Zs = (!et && hi.offsetHeight) || B.innerHeight),
      j.removeChild(hi));
  },
  zo = function (e) {
    return tn(
  ...
  sr = function (e) {
    if (e === 2 || (!rt && !Vi)) {
      ...
      if (
        ...
        rt || (Ms = n),
        i &&
          (Rt && !Wn && t - Rt > 200 && ((Rt = 0), Kr("scrollEnd")),
          (Di = rs),
          (rs = t)),
        Pn < 0)
      ) {
        for (tt = r; tt-- > 0;) Y[tt] && Y[tt].update(0, i);
        Pn = 1;
      } else for (tt = 0; tt < r; tt++) Y[tt] && Y[tt].update(0, i);
      G.isUpdating = !1;
    }
    rn = 0;
  },
    ...
    if (e) {
      ...
      for ((e.t._gsap || E.core.getCache(e.t)).uncache = 1; i < t; i += 2)
        ((s = e[i + 1]),
          ...
          s
            ? (r[n] = s)
            : r[n] && r.removeProperty(n.replace(Vl, "-$1").toLowerCase()));
    }
  },
  yn = function (e) {
  ...
  Fo = function (e, r, t, i, n, s, o, u, l, f, _, d, c, p) {
    (Ge(e) && (e = e(u)),
      gt(e) &&
        e.substr(0, 3) === "max" &&
        (e = d + (e.charAt(4) === "=" ? Cn("0" + e.substr(3), t) : 0)));
    var h = c ? c.time() : 0,
      m,
      b,
      T;
    if ((c && c.seek(0), isNaN(e) || (e = +e), Ai(e)))
      ...
      ((T = ot(r, u) || j),
        ...
        (w = Cn(S[0], v[i.d])),
        (k = Cn(S[1] || "0", t)),
        (e = v[i.p] - l[i.p] - f + w + n - k),
        o && kn(o, k, i, t - k < 20 || (o._isStart && k > 20)),
        (t -= t - k));
    }
    if ((p && ((u[p] = e || -0.001), e < 0 && (e = 0)), s)) {
      ...
      ((m = "scroll" + i.d2),
        kn(
          ...
          i,
          (C && O > 20) ||
            (!C && (_ ? Math.max(j[m], yt[m]) : s.parentNode[m]) <= O + 1),
        ),
        _ &&
          ((l = ir(o)),
  ...
  Io = function (e, r) {
    ...
    return (
      ...
      G.isTouch && Ee(e, "touchmove", t.wheelHandler),
      n
    );
  },
  G = (function () {
    ...
    return (
      (e.init = function (t, i) {
        ...
        t = Do(gt(t) || Ai(t) || t.nodeType ? { trigger: t } : t, gn);
        var n = t,
          s = n.onUpdate,
          o = n.toggleClass,
          u = n.id,
          ...
          K =
            ("pinType" in t
              ? t.pinType
              : br(M, "pinType") || (V && "fixed")) === "fixed",
          $ = [t.onEnter, t.onLeave, t.onEnterBack, t.onLeaveBack],
          z = F && t.toggleActions.split(" "),
          Z = "markers" in t ? t.markers : gn.markers,
          ne = V ? 0 : parseFloat(Mt(M)["border" + P.p2 + xi]) || 0,
          g = this,
          se =
            t.onRefreshInit &&
            function () {
        ...
        if (
          ...
          (m *= 45),
          (g.scroller = M),
          (g.scroll = x ? x.time.bind(x) : Te),
          (Qe = Te()),
          (g.vars = t),
          (i = i || t.animation),
          "refreshPriority" in t &&
            ((Ga = 1), t.refreshPriority === -9999 && (Hi = g)),
          ...
          i &&
            ...
            u || (u = i.vars.id)),
          v &&
            ((!Ir(v) || v.push) && (v = { snapTo: v }),
            "scrollBehavior" in j.style &&
              E.set(V ? [j, yt] : M, { scrollBehavior: "auto" }),
            X.forEach(function (D) {
              return (
                Ge(D) &&
                D.target === (V ? ie.scrollingElement || yt : M) &&
                (D.smooth = !1)
              );
            }),
            (ur = Ge(v.snapTo)
                ...
                : v.snapTo === "labelsDirectional"
                  ...
                  : v.directional !== !1
                    ? function (D, L) {
                        return to(v.snapTo)(
                          D,
                          We() - Ae < 500 ? 0 : L.direction,
                        );
                      }
                    : E.utils.snap(v.snapTo)),
            (Ft = v.duration || { min: 0.1, max: 2 }),
            (Ft = Ir(Ft) ? Xi(Ft.min, Ft.max) : Xi(Ft, Ft)),
            (Lt = E.delayedCall(v.delay || Dr / 2 || 0.1, function () {
              var D = Te(),
                L = We() - Ae < 500,
                R = Ke.tween;
              if (
                ...
                var I = (D - Q) / _e,
                  Me = i && !F ? i.totalProgress() : I,
                  H = L ? 0 : ((Me - Mr) / (We() - Di)) * 1e3 || 0,
                  ye = E.utils.clamp(-I, 1 - I, (ti(H / 2) * H) / 0.185),
                  Be = I + (v.inertia === !1 ? 0 : ye),
                  de,
                  oe,
                  ee = v,
                  Nt = ee.onStart,
                ...
                if (
                  ((de = ur(Be, g)),
                  Ai(de) || (de = Be),
                  (oe = Math.max(0, Math.round(Q + de * _e))),
                  D <= ge && D >= Q && oe !== D)
                ) {
                  if (R && !R._initted && R.data <= ti(oe - D)) return;
                  (v.inertia === !1 && (ye = de - I),
                    Ke(
                      oe,
                      {
                        duration: Ft(
                          ti(
                            (Math.max(ti(Be - Me), ti(de - Me)) * 0.185) /
                              H /
                              0.05 || 0,
                          ),
                        ),
          ...
          c &&
            ...
            Ye.spacer
              ...
              : (k &&
                  ...
                  (Ye.spacerIsNative = !!k),
                  k && (Ye.spacerState = yn(k))),
                (Ye.spacer = Oe = k || ie.createElement("div")),
            ...
            (Ti = Jr[p + P.os2]),
            (me = E.getProperty(c)),
            (zt = E.quickSetter(c, P.a, ke)),
            ss(c, Oe, Jr),
            (Or = yn(c))),
          Z)
        ) {
          ((Qt = Ir(Z) ? Do(Z, Eo) : Eo),
            (y = mn("scroller-start", u, M, P, Qt, 0)),
            (_t = mn("scroller-end", u, M, P, Qt, 0, y)),
            (cr = y["offset" + P.op.d2]));
          var bi = ot(br(M, "content") || M);
          ((st = this.markerStart = mn("start", u, bi, P, Qt, cr, 0, x)),
            (ht = this.markerEnd = mn("end", u, bi, P, Qt, cr, 0, x)),
            x && (jr = E.quickSetter([st, ht], P.a, ke)),
            !K &&
              !(qt.length && br(M, "fixedMarkers") === !0) &&
              (Ll(V ? j : M),
              E.set([y, _t], { force3D: !0 }),
              (sn = E.quickSetter(y, P.a, ke)),
              (Zr = E.quickSetter(_t, P.a, ke))));
        }
        if (x) {
          var N = x.vars.onUpdate,
            A = x.vars.onUpdateParams;
        ...
        if (
          ...
          (g.revert = function (D, L) {
            ...
            R !== g.isReverted &&
              (R &&
                ...
                (Er = i && i.progress())),
              st &&
                [st, ht, y, _t].forEach(function (Me) {
                  return (Me.style.display = R ? "none" : "block");
                }),
              R && ((Ue = g), g.update(R)),
              c &&
                (!w || !g.isActive) &&
                (R ? Xl(c, Oe, Zt) : ss(c, Oe, Mt(c), be)),
              R || g.update(R),
              (Ue = I),
              (g.isReverted = R));
          }),
          (g.refresh = function (D, L, R, I) {
            if (!((Ue || !g.enabled) && !L)) {
              ...
              (!rt && se && se(g),
                (Ue = g),
                Ke.tween && !R && (Ke.tween.kill(), (Ke.tween = 0)),
                U && U.pause(),
                h &&
                  i &&
              ...
              for (
                Z &&
                Ir(R) &&
                ((Si = E.getProperty(y, P.p)), (an = E.getProperty(_t, P.p)));
                ze-- > 0;
              )
                ((Ce = Y[ze]),
                  ...
                  Xt &&
                    (Xt === d || Xt === c || Xt === dt) &&
                    !Ce.isReverted &&
                    (wi || (wi = []), wi.unshift(Ce), Ce.revert(!0, !0)),
                  Ce !== Y[ze] && (Bt--, ze--));
              for (
                Ge(ue) && (ue = ue(g)),
                  ue = ko(ue, "start", g),
                  ...
                  gt(ee) &&
                    !ee.indexOf("+=") &&
                    (~ee.indexOf(" ")
                      ? (ee = (gt(ue) ? ue.split(" ")[0] : "") + ee)
                      : ((de = Cn(ee.substr(2), Me)),
                        (ee = gt(ue)
                          ? ue
                          : (x
                              ? E.utils.mapRange(
                ...
                ((Ce = Y[ze] || {}),
                  ...
                  Xt &&
                    ...
                    ((Xt === d && Ce.start - Ce._pinPush < Q) || Xt === dt) &&
                      isNaN(ue) &&
                      (de += Fe * (1 - Ce.progress)),
                    Xt === c && (oe += Fe)));
              if (
                ...
                g._endClamp &&
                  !rt &&
                  ((g._endClamp = ge || -0.001), (ge = Math.min(ge, Ht(M, P)))),
                (_e = ge - Q || ((Q -= 0.01) && 0.001)),
                Be && (Ne = E.utils.clamp(0, 1, E.utils.normalize(Q, ge, It))),
                (g._pinPush = oe),
                st &&
                  de &&
                  ((Fe = {}),
                ...
                ((Fe = Mt(c)),
                  (on = P === Pe),
                  (Rr = Te()),
                  (kt = parseFloat(me(P.a)) + oe),
                  !ye &&
                    ge > 1 &&
                    ((Vt = (V ? ie.scrollingElement || yt : M).style),
                    (Vt = {
                      style: Vt,
                      value: Vt["overflow" + P.a.toUpperCase()],
                    }),
                    V &&
                      Mt(j)["overflow" + P.a.toUpperCase()] !== "scroll" &&
                  ...
                  p
                    ? ((be = [p + P.os2, _e + oe + ke]),
                      (be.t = Oe),
                      (ze = p === we ? Yn(c, P) + _e + oe : 0),
                      ze &&
                        (be.push(P.d, ze + ke),
                        Oe.style.flexBasis !== "auto" &&
                          (Oe.style.flexBasis = ze + ke)),
                      _i(be),
                      dt &&
                        Y.forEach(function (_r) {
                          _r.pin === dt &&
                  ...
                  K &&
                    ((Ve = {
                      top: Xe.top + (on ? Rr - Q : $n) + ke,
                      left: Xe.left + (on ? $n : Rr - Q) + ke,
                      boxSizing: "border-box",
                      position: "fixed",
                    }),
                    (Ve[Wr] = Ve["max" + xi] = Math.ceil(Xe.width) + ke),
                    (Ve[$r] = Ve["max" + eo] = Math.ceil(Xe.height) + ke),
                    (Ve[Ot] =
                      Ve[Ot + $i] =
                      Ve[Ot + Ui] =
                      Ve[Ot + Gi] =
                ...
                for (Xe = d.parentNode; Xe && Xe !== j;)
                  (Xe._pinOffset &&
                    ((Q -= Xe._pinOffset), (ge -= Xe._pinOffset)),
                    (Xe = Xe.parentNode));
              (wi &&
                wi.forEach(function (_r) {
                  return _r.revert(!1, !0);
                }),
                (g.start = Q),
                (g.end = ge),
                (Qe = Ze = rt ? It : Te()),
                !x && !rt && (Qe < It && Te(It), (g.scroll.rec = 0)),
                g.revert(!1, !0),
                (Ae = We()),
                ...
                i &&
                  ...
                  (i._initted || Er) &&
                  i.progress() !== Er &&
                  i.progress(Er || 0, !0).render(i.time(), !0, !0),
                (Be || Ne !== g.progress || x || h || (i && !i._initted)) &&
                  (i &&
                    !F &&
                    (i._initted || Ne || i.vars.immediateRender !== !1) &&
                    i.totalProgress(
                      x && Q < -0.001 && !Ne ? E.utils.normalize(Q, ge, 0) : Ne,
                      !0,
                    ),
                  (g.progress = Be || (Qe - Q) / _e === Ne ? 0 : Ne)),
                c && p && (Oe._pinOffset = Math.round(g.progress * Jt)),
                U && U.invalidate(),
                isNaN(Si) ||
                  ((Si -= E.getProperty(y, P.p)),
                  (an -= E.getProperty(_t, P.p)),
                  vn(y, P, Si),
                  vn(st, P, Si - (I || 0)),
                  vn(_t, P, an),
                  vn(ht, P, an - (I || 0))),
          ...
          (g.endAnimation = function () {
            (Pi(g.callbackAnimation),
              i &&
                (U
                  ? U.progress(1)
                  : i.paused()
                    ? F || Pi(i, g.direction < 0, 1)
                    : Pi(i, i.reversed())));
          }),
          (g.labelToScroll = function (D) {
            return (
              (i &&
                i.labels &&
                (Q || g.refresh() || Q) + (i.labels[D] / i.duration()) * _e) ||
              0
            );
          }),
          (g.getTrailing = function (D) {
            var L = Y.indexOf(g),
              R = g.direction > 0 ? Y.slice(0, L).reverse() : Y.slice(L + 1);
            return (
              gt(D)
                ? R.filter(function (I) {
          ...
          (g.update = function (D, L, R) {
            if (!(x && !R && !D)) {
              var I = rt === !0 ? It : g.scroll(),
                Me = D ? 0 : (I - Q) / _e,
                H = Me < 0 ? 0 : Me > 1 ? 1 : Me || 0,
                ye = g.progress,
                Be,
                de,
                oe,
              ...
              if (
                (L &&
                  ((Ze = Qe),
                  (Qe = x ? Te() : I),
                  v && ((Mr = hr), (hr = i && !F ? i.totalProgress() : H))),
                m &&
                  c &&
                  !Ue &&
                  !hn &&
                ...
                if (
                  ...
                  (ue = Be !== de),
                  (Nt = ue || !!H != !!ye),
                  (g.direction = H > ye ? 1 : -1),
                  (g.progress = H),
                  Nt &&
                    !Ue &&
                    ((oe = H && !ye ? 0 : H === 1 ? 1 : ye === 1 ? 2 : 3),
                    F &&
                      ((ee =
                        (!ue && z[oe + 1] !== "none" && z[oe + 1]) || z[oe]),
                      (Bt =
                        i &&
                    ...
                    (U && !Ue && !hn
                      ? (U._dp._time - U._start !== U._time &&
                        ...
                        U.resetTo
                          ...
                          : ((U.vars.totalProgress = H),
                            U.invalidate().restart()))
                      : i && i.totalProgress(H, !!(Ue && (Ae || D)))),
                  c)
                ) {
                ...
                (v && !Ke.tween && !Ue && !hn && Lt.restart(!0),
                  o &&
                    (ue || (S && H && (H < 1 || !ts))) &&
                    tn(o.targets).forEach(function (Rr) {
                      return Rr.classList[Be || S ? "add" : "remove"](
                        o.className,
                      );
                    }),
                  s && !F && !D && s(g),
                  Nt && !Ue
                    ? (F &&
                      ...
                      (ue || !ts) &&
                        (l && ue && is(g, l),
                        $[oe] && is(g, $[oe]),
                        S && (H === 1 ? g.kill(!1, 1) : ($[oe] = 0)),
                        ue || ((oe = H === 1 ? 1 : 3), $[oe] && is(g, $[oe]))),
                      O &&
                        !Be &&
                        Math.abs(g.getVelocity()) > (Ai(O) ? O : 2500) &&
                        (Pi(g.callbackAnimation),
                        U
                          ? U.progress(1)
                          : Pi(i, ee === "reverse" ? 1 : !H, 1)))
                    : F && s && !Ue && s(g));
              }
              if (Zr) {
          ...
          (g.enable = function (D, L) {
            g.enabled ||
              ...
              D !== !1 && ((g.progress = Ne = 0), (Qe = Ze = he = Te())),
              L !== !1 && g.refresh());
          }),
          ...
          (g.setPositions = function (D, L, R, I) {
            if (x) {
              var Me = x.scrollTrigger,
                H = x.duration(),
                ye = Me.end - Me.start;
              ((D = Me.start + (ye * D) / H), (L = Me.start + (ye * L) / H));
            }
            (g.refresh(
              !1,
              !1,
          ...
          (g.adjustPinSpacing = function (D) {
            if (be && D) {
              var L = be.indexOf(P.d) + 1;
              ((be[L] = parseFloat(be[L]) + D + ke),
                (be[1] = parseFloat(be[1]) + D + ke),
                _i(be));
            }
          }),
          (g.disable = function (D, L) {
            if (
              ...
              for (var R = Y.length; R--;)
                if (Y[R].scroller === M && Y[R] !== g) return;
              (De(M, "resize", zi), V || De(M, "scroll", ri));
            }
          }),
          (g.kill = function (D, L) {
            (g.disable(D, L), U && !L && U.kill(), u && delete Os[u]);
            var R = Y.indexOf(g);
            (R >= 0 && Y.splice(R, 1),
              R === tt && Pn > 0 && tt--,
              (R = 0),
      ...
      (a.register = function (t) {
        return (
          ii ||
            ((E = t || Za()), Qa() && window.document && a.enable(), (ii = Ei)),
          ii
        );
      }),
      ...
      (a.disable = function (t, i) {
        ((Ei = 0),
          ...
          De(ie, "scroll", ri),
          clearInterval(cn),
          De(ie, "touchcancel", Wt),
          De(j, "touchstart", Wt),
          dn(De, ie, "pointerdown,touchstart,mousedown", Oo),
          dn(De, ie, "pointerup,touchend,mouseup", Mo),
          Nn.kill(),
          _n(De));
      ...
      (a.enable = function () {
        if (
          ...
          E &&
            ((tn = E.utils.toArray),
            (Xi = E.utils.clamp),
            (ks = E.core.context || Wt),
            (es = E.core.suppressOverwrites || Wt),
            (Qs = B.history.scrollRestoration || "auto"),
            (Ms = B.pageYOffset || 0),
          ...
          for (
            s.revert ||
              ...
              cn = setInterval(Ro, 250),
              E.delayedCall(0.5, function () {
                return (hn = 0);
              }),
              Ee(ie, "touchcancel", Wt),
              Ee(j, "touchstart", Wt),
              dn(Ee, ie, "pointerdown,touchstart,mousedown", Oo),
              dn(Ee, ie, "pointerup,touchend,mouseup", Mo),
              Ss = E.utils.checkPrefix("transform"),
              On.push(Ss),
              ii = We(),
              Nn = E.delayedCall(0.2, Yr).pause(),
              ni = [
                ie,
                "visibilitychange",
                function () {
      ...
      (a.config = function (t) {
        ...
        ((i && clearInterval(cn)) || ((cn = i) && setInterval(Ro, i)),
          "ignoreMobileResize" in t &&
            (Cs = a.isTouch === 1 && t.ignoreMobileResize),
          "autoRefreshEvents" in t &&
            (_n(De) || _n(Ee, t.autoRefreshEvents || "none"),
            (Ha = (t.autoRefreshEvents + "").indexOf("resize") === -1)));
      }),
      (a.scrollerProxy = function (t, i) {
        var n = ot(t),
          ...
          o = Hr(n);
        (~s && X.splice(s, o ? 6 : 2),
          i && (o ? qt.unshift(B, i, j, i, yt, i) : qt.unshift(n, i)));
      }),
      ...
      (a.isInViewport = function (t, i, n) {
        var s = (gt(t) ? ot(t) : t).getBoundingClientRect(),
          o = s[n ? Wr : $r] * i || 0;
        return n
          ? s.right - o > 0 && s.left + o < B.innerWidth
          : s.bottom - o > 0 && s.top + o < B.innerHeight;
      }),
...
G.refresh = function (a) {
  return a ? zi(!0) : (ii || G.register()) && Yr(!0);
};
G.update = function (a) {
...
var No = function (e, r, t, i) {
    ...
    if (!s._isScrollT || o - s._isScrollT > 2e3) {
      for (
        ...
        ((n.scrollHeight <= n.clientHeight && n.scrollWidth <= n.clientWidth) ||
          !(xn[(u = Mt(n)).overflowY] || xn[u.overflowX]));
      )
        n = n.parentNode;
      ((s._isScroll =
        n &&
  ...
  lu = function (e, r, t, i) {
    return xe.create({
      ...
      onScroll: i,
      onEnable: function () {
        return t && Ee(ie, xe.eventTypes[0], Bo, !1, !0);
      },
      onDisable: function () {
        return De(ie, xe.eventTypes[0], Bo, !0);
      },
    });
  },
  Gl = /(input|label|select|textarea)/i,
  Yo,
  Bo = function (e) {
    var r = Gl.test(e.target.tagName);
  ...
  Hl = function (e) {
    ...
    var r = e,
      ...
      P = function () {
        ((d._gsap.y = Ri(parseFloat(d._gsap.y) + c.offset) + "px"),
          (d.style.transform =
      ...
      $ = function () {
        (C(),
          M.isActive() &&
            M.vars.scrollY > u &&
            (c() > u ? M.progress(1) && c(u) : M.resetTo("scrollY", u)));
      };
    return (
      d && E.set(d, { y: "+=0" }),
      (e.ignoreCheck = function (z) {
        return (
          (dr && z.type === "touchmove" && F()) ||
          (h > 1.05 && z.type !== "touchstart") ||
          o.isGesturing ||
      ...
      (e.onPress = function () {
        v = !1;
        var z = h;
        ((h = Ri(((B.visualViewport && B.visualViewport.scale) || 1) / m)),
          M.pause(),
          z !== h && os(l, h > 1.01 ? !0 : t ? !1 : "x"),
          (W = p()),
          (V = c()),
          C(),
          (S = Gr));
      ...
      (e.onRelease = e.onGestureStart =
        function (z, Z) {
          if ((c.offset && P(), !Z)) K.restart(!0);
            ...
            (t &&
              ((g = p()),
              (se = g + (ne * 0.05 * -z.velocityX) / 0.227),
              (ne *= No(p, g, se, Ht(l, nt))),
              (M.vars.scrollX = x(se))),
              (g = c()),
              (se = g + (ne * 0.05 * -z.velocityY) / 0.227),
              (ne *= No(c, g, se, Ht(l, Pe))),
              (M.vars.scrollY = O(se)),
              M.invalidate().duration(ne).play(0.01),
              ((dr && M.vars.scrollY >= u) || g >= u - 1) &&
                E.to({}, { onUpdate: $, duration: ne }));
          }
          s && s(z);
        }),
      (e.onWheel = function () {
      ...
      (e.onChange = function (z, Z, ne, g, se) {
        if (
          (Gr !== S && C(),
          Z && t && p(x(g[2] === Z ? W + (z.startX - z.x) : p() + Z - g[1])),
          ne)
        ) {
          c.offset && P();
          var qe = se[2] === ne,
            At = qe ? V + z.startY - z.y : c() + ne - se[1],
            he = O(At);
          (qe && At !== he && (V += he - At), c(he));
        }
        (ne || Z) && sr();
      }),
      (e.onEnable = function () {
...
Za() && E.registerPlugin(G);
export { G as S, Ol as g };
